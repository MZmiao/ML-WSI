...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default="./fashion-product-images", help="Path to the dataset")
    ...
    inds = np.random.choice(2093, 2093, replace=False)
    # split the data into train/val and save them as csv files
    save_csv(all_data[inds][:1674], os.path.join(output_folder, 'train.csv'))
    save_csv(all_data[inds][1674:2093], os.path.join(output_folder, 'val.csv'))
